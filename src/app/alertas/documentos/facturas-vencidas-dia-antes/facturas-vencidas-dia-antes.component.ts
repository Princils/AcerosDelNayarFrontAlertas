...
@Component({
  selector: 'app-facturas-vencidas-dia-antes',
  templateUrl: './facturas-vencidas-dia-antes.component.html',
  styleUrl: './facturas-vencidas-dia-antes.component.css'
})
export class FacturasVencidasDiaAntesComponent {
...
ngOnInit(): void {
  ...
  BuscarAlertaDinamica(): any {
    ...
    this.ReportesDocumentosService.PostFacturasVencidasDiaAntes(this.formularioPrincipal.value).subscribe(
      respuesta => {
