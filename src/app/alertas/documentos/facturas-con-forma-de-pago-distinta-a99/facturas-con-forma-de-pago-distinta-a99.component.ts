...
@Component({
  selector: 'app-facturas-con-forma-de-pago-distinta-a99',
  templateUrl: './facturas-con-forma-de-pago-distinta-a99.component.html',
  styleUrl: './facturas-con-forma-de-pago-distinta-a99.component.css'
})
export class FacturasConFormaDePagoDistintaA99Component {
...
ngOnInit(): void {
  ...
  BuscarAlertaDinamica(): any {
    ...
    this.ReportesDocumentosService.PostFacturasConFormaPagoDistintaA99(this.formularioPrincipal.value).subscribe(
      respuesta => {
